      ...
      <div className="container body-container">
        <Row>
          ...
          <Col xs={12} sm={6} md={6} lg={6}>
            <div className="info">
              <a href="https://github.com/Thepriestdude" className="black">
                <i className="fa fa-github" aria-hidden="true"/>&nbsp;&nbsp;
              </a>
              <a href="https://www.linkedin.com/in/oskarselberg" className="black">
          ...
          <Col xs={12} sm={6} md={6} lg={6}>
            <div className="info">
              <a href="../media/CV_Oskar_Selberg_Eng.pdf" className="black" download>
